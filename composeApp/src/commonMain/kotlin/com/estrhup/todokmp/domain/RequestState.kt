package com.estrhup.todokmp.domain
...
sealed class RequestState<out T> {
     ...
     * @throws ClassCastException if the current state isn't [Success]
     **/
     ...
     * @throws ClassCastException if the current state isn't [Error]
     **/
